...
Once we have our transaction, we need to sign and send it to the network.

In this example, we'll use the `sendAndConfirmTransaction` function to sign, send, and confirm a transaction.
